...
export const languages: Record<LanguageKey, LanguageStrings> = {
  english: {
    ...
    timedTestDescription: 'Test your recall speed! Cards are shown in your language, then the German answer is revealed after a delay.',
    ...
    testMode: 'Test Mode',
    listenModeDesc: 'Listen to vocabulary while on the go',
    pause: 'Pause',
    resume: 'Resume',
    stop: 'Stop',
    nextWordIn: 'Next word in',
    listeningComplete: 'Listening Complete!',
    wordsListened: 'Words listened',
    // Word Search Game
    wordSearch: 'Word Search',
    wordSearchDesc: 'Find hidden German words in the grid',
  ...
  ukrainian: {
    ...
    timedTest: 'Тест на час',
    timedTestDescription: 'Перевірте швидкість згадування! Картки показуються вашою мовою, потім німецька відповідь з\'являється після затримки.',
    revealDelay: 'Затримка показу',
    seconds: 'секунд',
    gotIt: 'Знаю!',
    needsPractice: 'Потрібна практика',
    revealing: 'Показ через',
    testComplete: 'Тест завершено!',
    cardsReviewed: 'Переглянуто карток',
    retry: 'Повторити все',
    ...
    // Listen Mode
    listenMode: 'Режим прослуховування',
    testMode: 'Режим тесту',
    listenModeDesc: 'Слухайте лексику в дорозі',
    pause: 'Пауза',
    resume: 'Продовжити',
    stop: 'Зупинити',
    nextWordIn: 'Наступне слово через',
    listeningComplete: 'Прослуховування завершено!',
    wordsListened: 'Прослухано слів',
    // Word Search Game
    wordSearch: 'Пошук слів',
    wordSearchDesc: 'Знайдіть приховані німецькі слова в сітці',
    wordsToFind: 'Слова для пошуку',
    foundWord: 'Знайдено!',
    allWordsFound: 'Всі слова знайдено!',
    timeElapsed: 'Час',
    easy: 'Легко',
    medium: 'Середній',
    hard: 'Важкий',
    wordCount: 'слів',
    directions: 'Напрямки',
    horizontalVertical: 'Горизонтальний і вертикальний',
    withDiagonals: '+ Діагоналі',
    allDirections: 'Всі напрямки',
    congratulations: 'Вітаємо!',
    yourTime: 'Ваш час',
    wordsFoundCount: 'Знайдено слів',
  },
  polish: {
    name: 'Polski',
    ...
    timedTest: 'Test czasowy',
    timedTestDescription: 'Sprawdź szybkość przypominania! Karty są pokazywane w Twoim języku, a następnie po opóźnieniu pojawia się niemiecka odpowiedź.',
    revealDelay: 'Opóźnienie pokazania',
    seconds: 'sekund',
    gotIt: 'Wiem!',
    needsPractice: 'Potrzebuję praktyki',
    revealing: 'Pokazanie za',
    testComplete: 'Test ukończony!',
    cardsReviewed: 'Przejrzane karty',
    ...
    testMode: 'Tryb testu',
    listenModeDesc: 'Słuchaj słownictwa w podróży',
    pause: 'Pauza',
    resume: 'Wznów',
    stop: 'Zatrzymaj',
    nextWordIn: 'Następne słowo za',
    listeningComplete: 'Słuchanie zakończone!',
    wordsListened: 'Odsłuchane słowa',
    // Word Search Game
    wordSearch: 'Szukaj słów',
    wordSearchDesc: 'Znajdź ukryte niemieckie słowa w siatce',
    wordsToFind: 'Słowa do znalezienia',
    foundWord: 'Znaleziono!',
    allWordsFound: 'Wszystkie słowa znalezione!',
    timeElapsed: 'Czas',
    easy: 'Łatwy',
    medium: 'Średni',
    hard: 'Trudny',
    wordCount: 'słów',
    directions: 'Kierunki',
    horizontalVertical: 'Poziomo i pionowo',
    withDiagonals: '+ Przekątne',
    allDirections: 'Wszystkie kierunki',
    congratulations: 'Gratulacje!',
    yourTime: 'Twój czas',
    wordsFoundCount: 'Znalezione słowa',
  },
  albanian: {
    name: 'Shqip',
    ...
    timedTest: 'Test me kohë',
    timedTestDescription: 'Testoni shpejtësinë tuaj të kujtimit! Kartat shfaqen në gjuhën tuaj, pastaj përgjigja gjermane zbulohet pas një vonese.',
    revealDelay: 'Vonesa e zbulimit',
    seconds: 'sekonda',
    gotIt: 'E di!',
    needsPractice: 'Kam nevojë për praktikë',
    revealing: 'Zbulimi në',
    testComplete: 'Testi u përfundua!',
    cardsReviewed: 'Karta të rishikuara',
    ...
    // Listen Mode
    listenMode: 'Modaliteti i dëgjimit',
    testMode: 'Modaliteti i testit',
    listenModeDesc: 'Dëgjoni fjalorin në lëvizje',
    pause: 'Ndalo',
    resume: 'Vazhdo',
    stop: 'Ndalo',
    nextWordIn: 'Fjala tjetër për',
    listeningComplete: 'Dëgjimi u përfundua!',
    wordsListened: 'Fjalë të dëgjuara',
    // Word Search Game
    wordSearch: 'Kërko fjalë',
    wordSearchDesc: 'Gjeni fjalët gjermane të fshehura në rrjetë',
    wordsToFind: 'Fjalët për të gjetur',
    foundWord: 'U gjet!',
    allWordsFound: 'Të gjitha fjalët u gjetën!',
    timeElapsed: 'Koha',
    easy: 'E lehtë',
    medium: 'Mesatare',
    hard: 'E vështirë',
    ...
    horizontalVertical: 'Horizontale dhe vertikale',
    withDiagonals: '+ Diagonale',
    allDirections: 'Të gjitha drejtimet',
    congratulations: 'Urime!',
    yourTime: 'Koha juaj',
    wordsFoundCount: 'Fjalët e gjetura',
  },
  german: {
    name: 'Deutsch',
    ...
    timedTest: 'Zeittest',
    timedTestDescription: 'Teste deine Erinnerungsgeschwindigkeit! Karten werden in deiner Sprache angezeigt, dann wird die deutsche Antwort nach einer Verzögerung enthüllt.',
    revealDelay: 'Enthüllungsverzögerung',
    seconds: 'Sekunden',
    gotIt: 'Gewusst!',
    needsPractice: 'Brauche Übung',
    revealing: 'Enthüllung in',
    ...
    listenMode: 'Hörmodus',
    testMode: 'Testmodus',
    listenModeDesc: 'Vokabeln unterwegs hören',
    pause: 'Pause',
    resume: 'Fortsetzen',
    stop: 'Stopp',
    nextWordIn: 'Nächstes Wort in',
    listeningComplete: 'Hören abgeschlossen!',
    wordsListened: 'Angehörte Wörter',
    // Word Search Game
    wordSearch: 'Wortsuche',
    wordSearchDesc: 'Finde versteckte deutsche Wörter im Gitter',
    ...
    horizontalVertical: 'Horizontal & Vertikal',
    withDiagonals: '+ Diagonal',
  ...
  arabic: {
    ...
    timedTestDescription: 'اختبر سرعة تذكرك! تُعرض البطاقات بلغتك، ثم تُكشف الإجابة الألمانية بعد تأخير.',
    revealDelay: 'تأخير الكشف',
    seconds: 'ثواني',
    gotIt: 'عرفتها!',
    needsPractice: 'أحتاج تدريب',
    revealing: 'الكشف خلال',
    ...
    listenModeDesc: 'استمع للمفردات أثناء التنقل',
    pause: 'إيقاف مؤقت',
    resume: 'استئناف',
    stop: 'إيقاف',
    nextWordIn: 'الكلمة التالية في',
    listeningComplete: 'اكتمل الاستماع!',
    wordsListened: 'الكلمات المستمعة',
    // Word Search Game
    wordSearch: 'البحث عن الكلمات',
    wordSearchDesc: 'ابحث عن الكلمات الألمانية المخفية في الشبكة',
    wordsToFind: 'الكلمات للبحث عنها',
    foundWord: 'وُجدت!',
    ...
    horizontalVertical: 'أفقي وعمودي',
    withDiagonals: '+ قُطري',
    allDirections: 'جميع الاتجاهات',
    congratulations: 'تهانينا!',
    yourTime: 'وقتك',
    wordsFoundCount: 'الكلمات المُكتشفة',
  },
  italian: {
    name: 'Italiano',
    ...
    timedTest: 'Test a tempo',
    timedTestDescription: 'Metti alla prova la tua velocità di richiamo! Le schede vengono mostrate nella tua lingua, poi la risposta tedesca viene rivelata dopo un ritardo.',
    revealDelay: 'Ritardo di rivelazione',
    seconds: 'secondi',
    gotIt: 'Lo so!',
    needsPractice: 'Ho bisogno di pratica',
    revealing: 'Rivelazione tra',
    testComplete: 'Test completato!',
    cardsReviewed: 'Schede revisionate',
    retry: 'Riprova tutte',
    ...
    listenModeDesc: 'Ascolta il vocabolario in movimento',
    pause: 'Pausa',
    resume: 'Riprendi',
    stop: 'Ferma',
    nextWordIn: 'Prossima parola tra',
    listeningComplete: 'Ascolto completato!',
    wordsListened: 'Parole ascoltate',
    // Word Search Game
    wordSearch: 'Cerca parole',
    wordSearchDesc: 'Trova le parole tedesche nascoste nella griglia',
    ...
    horizontalVertical: 'Orizzontale e verticale',
    withDiagonals: '+ Diagonali',
  ...
  serbian: {
    ...
    timedTest: 'Тест на време',
    timedTestDescription: 'Тестирајте брзину присећања! Картице се приказују на вашем језику, а затим се немачки одговор открива након кашњења.',
    revealDelay: 'Кашњење откривања',
    seconds: 'секунди',
    gotIt: 'Знам!',
    needsPractice: 'Треба ми вежба',
    revealing: 'Откривање за',
    testComplete: 'Тест завршен!',
    cardsReviewed: 'Прегледане картице',
    retry: 'Понови све',
    ...
    // Listen Mode
    listenMode: 'Режим слушања',
    testMode: 'Режим теста',
    listenModeDesc: 'Слушајте речник у покрету',
    pause: 'Пауза',
    resume: 'Настави',
    stop: 'Заустави',
    nextWordIn: 'Следећа реч за',
    listeningComplete: 'Слушање завршено!',
    wordsListened: 'Саслушане речи',
    // Word Search Game
    wordSearch: 'Потрага за речима',
    wordSearchDesc: 'Пронађите скривене немачке речи у мрежи',
    wordsToFind: 'Речи за проналажење',
    foundWord: 'Пронађено!',
    allWordsFound: 'Све речи пронађене!',
    timeElapsed: 'Време',
    easy: 'Лако',
    medium: 'Средње',
    hard: 'Тешко',
    wordCount: 'речи',
    directions: 'Правци',
    horizontalVertical: 'Хоризонтално и вертикално',
    withDiagonals: '+ Дијагонале',
    allDirections: 'Сви правци',
    congratulations: 'Честитамо!',
    yourTime: 'Ваше време',
    wordsFoundCount: 'Пронађене речи',
  }
};